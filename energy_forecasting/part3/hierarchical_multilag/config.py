...
CONFIG = {
    ...
    "temporal_layers": 6,      # match Cooper's trained hierarchical (config file said 4 but ckpt was 6)
    "num_heads": 8,
    ...
    # Multi-lag: number of lag tensors fed into future tabular embedder.
    # num_lags=2 → 168h-prior + 24h-prior demand. Each adds Z dims.
    "num_lags": 2,

    # ── Checkpointing ────────────────────────────────────────────────────────
    "checkpoint_dir": "checkpoints/hierarchical_multilag",
    "checkpoint_name": "best_model_hierarchical_multilag.pt",
}

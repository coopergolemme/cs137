...
class EnergyDataset(Dataset):
    ...
    def __getitem__(self, idx: int):
        ...
        # Demand from the same 24 hours one week (168 h) prior — weekly lag.
        lag_start = start + self.S - 168
        future_demand_lag = torch.from_numpy(
            self.demand_values[lag_start : lag_start + self.H]     # (24, Z)
        )
